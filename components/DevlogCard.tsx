...
export function DevlogCard({ slug, title, date, summary, tags = [] }: DevlogCardProps) {
  return (
    <article className="rounded-lg border border-slate-200 bg-white p-5 shadow-sm transition hover:-translate-y-0.5 hover:border-slate-300 hover:shadow-md">
      <p className="text-xs font-semibold uppercase tracking-normal text-circuit">{formatDate(date)}</p>
